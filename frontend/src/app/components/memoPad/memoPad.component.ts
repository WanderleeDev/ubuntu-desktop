...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, WindowControlComponent, DragDropModule],
...
export class MemoPadComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.logicController = {
      maximize: this.windowController.maximizeWindow.bind(
        this.windowController
      ),
      minimize: this.windowController.minimizeWindow.bind(
        this.windowController
      ),
